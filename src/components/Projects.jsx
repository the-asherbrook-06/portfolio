  ...
  return (
    <>
      ...
      <div className="projects">
        <div className="card">
          <img src="https://github.com/the-asherbrook-06/portfolio/blob/main/public/Tasker.svg" alt="The Tasker" className="card-image" />
        ...
        <div className="card">
          <img src="https://github.com/the-asherbrook-06/portfolio/blob/main/public/\Budget_Tracker.svg" alt="Budget Tracker" className="card-image" />
          <div className="space-image"></div>
        ...
        <div className="card">
          <img src="https://github.com/the-asherbrook-06/portfolio/blob/main/public/Weather_tracker.svg" alt="Weather Watcher" className="card-image" />
          <div className="space-image"></div>
        ...
        <div className="card">
          <img src="https://github.com/the-asherbrook-06/portfolio/blob/main/public/Fitness_tracker.svg" alt="Fitness Tracker" className="card-image" />
          <div className="space-image"></div>
        ...
        <div className="card">
          <img src="https://github.com/the-asherbrook-06/portfolio/blob/main/public/Anime_recommender.svg" alt="Fitness Tracker" className="card-image" />
          <div className="space-image"></div>
